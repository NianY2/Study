...
# }
    # # 全局配置异常模块
    # 'EXCEPTION\_HANDLER': 'utils.response.exception.custom\_handler',
    # # 修改默认返回JSON的renderer的类
    # 'DEFAULT\_RENDERER\_CLASSES': ('utils.response.renderer.CustomRenderer',),
...
SECRET_KEY = 'django-insecure--mq-al@#ichd87)obg^ap@ngo-6rp#+=37lcv9cxk2bq*=o$ic'
